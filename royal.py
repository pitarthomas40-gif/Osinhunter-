...
# ================== CONFIG ==================
BOT_TOKEN = "8384588465:AAHYjd3lp_HYMK6oS62voegZJUEU2PYElxw"   # <-- apna bot token
ADMIN_IDS = [7374664332]                # <-- apna Telegram user id (int)

DEFAULT_CREDITS = 10    # first time user = 10 credits
LOOKUP_COST = 1         # har lookup pe 1 credit

# Force channel join
CHANNEL_ID = -1003615939913
CHANNEL_LINK = "https://t.me/+GMvbheOxzL4zZmI0"
